...
const CACHE = 'dbz-v29';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./cloud.js','./collection.js','./inventory.js','./bridge-export.js','./products.js','./manifest.json','./icon-192.png','./icon-512.png','./update-banner.png'];
