...
const CACHE = 'dbz-v69';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./collection.js','./inventory.js','./bridge-export.js','./products.js','./backup.js','./scanner.js','./manifest.json','./icon-192.png','./icon-512.png','./update-banner.png'];
